#include "ma5600brasplandialog.h"
#include "ui_ma5600brasplandialog.h"
#include <QSqlQuery>
#include "lib/database/danetdbman.h"
#include <QMessageBox>

MA5600BrasPlanDialog::MA5600BrasPlanDialog(QWidget *parent, DanetDbMan *Db, const int Area, const int ExchId, const int DslamId, const QString dslamName) :
    QDialog(parent),
    ui(new Ui::MA5600BrasPlanDialog),
    dbMan(Db),
    area(Area),
    dslamId(DslamId)
{
...
MA5600BrasPlanDialog::~MA5600BrasPlanDialog()
{
    delete ui;
}

void MA5600BrasPlanDialog::checkEntry()
{
...
void MA5600BrasPlanDialog::fillDesc()
{
    if(agg.isEmpty())
    {
        ui->v500DescLE->clear();
...
void MA5600BrasPlanDialog::on_bras1CB_currentIndexChanged(int index)
{
    index++;
...
void MA5600BrasPlanDialog::on_bras2CB_currentIndexChanged(int index)
{
    index++;
...
void MA5600BrasPlanDialog::on_bras2EnCB_toggled(bool checked)
{
    if(checked)
    {
...
void MA5600BrasPlanDialog::on_okBtn_clicked()
{
    bool ok = true;
...
void MA5600BrasPlanDialog::on_vlan500CB_currentIndexChanged(int index)
{
...
void MA5600BrasPlanDialog::on_vlan600CB_currentIndexChanged(int index)
{
    index++;
    fillDesc();
}

void MA5600BrasPlanDialog::on_vlan700CB_currentIndexChanged(int index)
{
    index++;
    fillDesc();
}

void MA5600BrasPlanDialog::on_vlan800CB_currentIndexChanged(int index)
{
    index++;
    fillDesc();
}

void MA5600BrasPlanDialog::on_back3Btn_clicked()
{
    ui->tabWidget->setCurrentIndex(1);
}

void MA5600BrasPlanDialog::on_next2Btn_clicked()
{
    ui->tabWidget->setCurrentIndex(2);
}

void MA5600BrasPlanDialog::on_back2Btn_clicked()
{
    ui->tabWidget->setCurrentIndex(0);
}

void MA5600BrasPlanDialog::on_next1Btn_clicked()
{
    ui->tabWidget->setCurrentIndex(1);
}
