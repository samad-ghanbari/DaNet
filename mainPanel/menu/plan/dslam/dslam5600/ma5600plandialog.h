...
private slots:
    ...
    void on_desc080LE_textChanged(const QString &arg1);

    void on_desc081LE_textChanged(const QString &arg1);

    void on_desc082LE_textChanged(const QString &arg1);

    void on_desc083LE_textChanged(const QString &arg1);

    void on_desc084LE_textChanged(const QString &arg1);

    void on_desc085LE_textChanged(const QString &arg1);
