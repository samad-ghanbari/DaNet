#include "ma5600singleaggmetroplandialog.h"
#include "ui_ma5600singleaggmetroplandialog.h"
#include <QSqlQuery>
#include "lib/database/danetdbman.h"
#include <QMessageBox>

MA5600SingleAggMetroPlanDialog::MA5600SingleAggMetroPlanDialog(QWidget *parent, DanetDbMan *Db, const int ExchId, const int DslamId) :
    QDialog(parent),
    ui(new Ui::MA5600SingleAggMetroPlanDialog),
    dbMan(Db),
    exchId(ExchId),
    dslamId(DslamId)

{
    ...
    ui->a1i2diCB->addItem("1G-0/8/0", 0);
    ui->a1i2diCB->addItem("1G-0/8/1", 1);
    ui->a1i2diCB->addItem("1G-0/8/2", 2);
    ui->a1i2diCB->addItem("1G-0/8/3", 3);
    ui->a1i2diCB->addItem("1G-0/8/4", 4);
    ui->a1i2diCB->addItem("1G-0/8/5", 5);
    ui->a1i2diCB->blockSignals(false);

    ui->a1i3diCB->blockSignals(true);
    ui->a1i3diCB->addItem("1G-0/7/0", 0);
    ui->a1i3diCB->addItem("1G-0/7/1", 1);
    ui->a1i3diCB->addItem("1G-0/7/2", 2);
    ui->a1i3diCB->addItem("1G-0/7/3", 3);
    ui->a1i3diCB->addItem("1G-0/7/4", 4);
    ui->a1i3diCB->addItem("1G-0/7/5", 5);
    ui->a1i3diCB->blockSignals(false);

    ui->a1i4diCB->blockSignals(true);
    ui->a1i4diCB->addItem("1G-0/8/0", 0);
    ui->a1i4diCB->addItem("1G-0/8/1", 1);
    ui->a1i4diCB->addItem("1G-0/8/2", 2);
    ui->a1i4diCB->addItem("1G-0/8/3", 3);
    ui->a1i4diCB->addItem("1G-0/8/4", 4);
    ui->a1i4diCB->addItem("1G-0/8/5", 5);
    ...
    ui->a1i2diCB->setCurrentIndex(2);
    ui->a1i3diCB->setCurrentIndex(3);
    ui->a1i4diCB->setCurrentIndex(3);
...
MA5600SingleAggMetroPlanDialog::~MA5600SingleAggMetroPlanDialog()
{
    delete ui;
}

void MA5600SingleAggMetroPlanDialog::checkEntry()
{
...
void MA5600SingleAggMetroPlanDialog::on_agg1CB_currentIndexChanged(int index)
{
    index++;
    AggChanged = true;
...
void MA5600SingleAggMetroPlanDialog::on_okBtn_clicked()
{
...
void MA5600SingleAggMetroPlanDialog::on_agg1EthSB_valueChanged(int arg1)
{
    arg1++;
    AggChanged = true;
    checkEntry();
...
void MA5600SingleAggMetroPlanDialog::on_agg1Int1CB_currentIndexChanged(int index)
{
    index++;
    AggChanged = true;
...
void MA5600SingleAggMetroPlanDialog::on_agg1Int2CB_currentIndexChanged(int index)
{
    index++;
    AggChanged = true;
...
void MA5600SingleAggMetroPlanDialog::on_agg1Int3CB_currentIndexChanged(int index)
{
    index++;
    AggChanged = true;
    checkEntry();
...
void MA5600SingleAggMetroPlanDialog::on_agg1Int4CB_currentIndexChanged(int index)
{
    index++;
    AggChanged = true;
    checkEntry();
...
void MA5600SingleAggMetroPlanDialog::on_agg14IntCB_toggled(bool checked)
{
    AggChanged = true;
    if(checked)
    {
...
void MA5600SingleAggMetroPlanDialog::on_agg1ConnCB_toggled(bool checked)
{
    AggChanged = true;
    if(checked)
    {
...
void MA5600SingleAggMetroPlanDialog::on_metroConnCB_toggled(bool checked)
{
    cxChanged = true;
    AggChanged = true;
...
void MA5600SingleAggMetroPlanDialog::on_cxdIntCB_toggled(bool checked)
{
    cxChanged = true;
    if(checked)
    {
...
void MA5600SingleAggMetroPlanDialog::on_cxCB_currentIndexChanged(int index)
{
    index++;
    cxChanged = true;
    ui->cxInt1CB->clear();
...
void MA5600SingleAggMetroPlanDialog::on_a1i1diCB_currentIndexChanged(int index)
{
    index++;
    AggChanged = true;
    checkEntry();
...
void MA5600SingleAggMetroPlanDialog::on_a1i2diCB_currentIndexChanged(int index)
{
    index++;
    AggChanged = true;
    checkEntry();
...
void MA5600SingleAggMetroPlanDialog::on_a1i3diCB_currentIndexChanged(int index)
{
    index++;
    AggChanged = true;
    checkEntry();
...
void MA5600SingleAggMetroPlanDialog::on_a1i4diCB_currentIndexChanged(int index)
{
    index++;
    AggChanged = true;
    checkEntry();
...
void MA5600SingleAggMetroPlanDialog::on_cxi1diCB_currentIndexChanged(int index)
{
    index++;
    cxChanged = true;
    checkEntry();
...
void MA5600SingleAggMetroPlanDialog::on_cxi2diCB_currentIndexChanged(int index)
{
    index++;
    cxChanged = true;
    checkEntry();
...
void MA5600SingleAggMetroPlanDialog::on_cxInt1CB_currentIndexChanged(int index)
{
    index++;
    cxChanged = true;
    checkEntry();
...
void MA5600SingleAggMetroPlanDialog::on_cxInt2CB_currentIndexChanged(int index)
{
    index++;
    cxChanged = true;
    checkEntry();
...
void MA5600SingleAggMetroPlanDialog::on_a1mCB_currentTextChanged(const QString &arg1)
{
    if(arg1.isEmpty())
        AggChanged = true;
    else
...
void MA5600SingleAggMetroPlanDialog::on_cxmCB_currentIndexChanged(int index)
{
    index++;
    cxChanged = true;
    checkEntry();
...
void MA5600SingleAggMetroPlanDialog::on_cxEthSB_valueChanged(int arg1)
{
    arg1++;
    cxChanged = true;
    checkEntry();
...
void MA5600SingleAggMetroPlanDialog::on_nextBtn_clicked()
{
    ui->tabWidget->setCurrentIndex(1);
}

void MA5600SingleAggMetroPlanDialog::on_metroBackBtn_clicked()
{
