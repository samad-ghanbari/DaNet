...
void MA5600PlanDialog::fillDslamParam()
{
    ...
    ui->desc080LE->blockSignals(true);
    ui->desc081LE->blockSignals(true);
    ui->desc082LE->blockSignals(true);
    ui->desc083LE->blockSignals(true);
    ui->desc084LE->blockSignals(true);
    ui->desc085LE->blockSignals(true);
    ...
    while(query->next())
    {
        ...
        else if(port.compare("1G-0/8/0", Qt::CaseInsensitive) == 0)
                                ui->desc080LE->setText(desc);
                            else
                                if(port.compare("1G-0/8/1", Qt::CaseInsensitive) == 0)
                                    ui->desc081LE->setText(desc);
                                else
                                    if(port.compare("1G-0/8/2", Qt::CaseInsensitive) == 0)
                                        ui->desc082LE->setText(desc);
                                    else
                                        if(port.compare("1G-0/8/3", Qt::CaseInsensitive) == 0)
                                            ui->desc083LE->setText(desc);
                                        else
                                            if(port.compare("1G-0/8/4", Qt::CaseInsensitive) == 0)
                                                ui->desc084LE->setText(desc);
                                            else
                                                if(port.compare("1G-0/8/5", Qt::CaseInsensitive) == 0)
                                                    ui->desc085LE->setText(desc);
    ...
    ui->desc080LE->blockSignals(false);
    ui->desc081LE->blockSignals(false);
    ui->desc082LE->blockSignals(false);
    ui->desc083LE->blockSignals(false);
    ui->desc084LE->blockSignals(false);
    ui->desc085LE->blockSignals(false);
    ...
    if(node > 1)
        if(ui->desc070LE->text().isEmpty())
        {
            ...
            if(uplinkSiteId > -1)
            {
                ...
                {
                    ok = ok && dbMan->insertUpdateDslamInterface(devexId,"1G-0/7/0", uplinkDevexName);
                    ok = ok && dbMan->insertUpdateDslamInterface(devexId,"1G-0/8/0", uplinkDevexName);
                    ...
                    if(!dbMan->dslamInterfaceExistence(uplinkDevexId, "1G-0/7/4"))
                    {
                        ...
                        ok = ok && dbMan->insertUpdateDslamInterface(uplinkDevexId,"1G-0/8/4", name+" 1G-0/8/0");
                    ...
                    else
                    {
                        ...
                        ok = ok && dbMan->insertUpdateDslamInterface(uplinkDevexId,"1G-0/8/5", name+" 1G-0/8/0");
                    }
...
void MA5600PlanDialog::on_desc7BackBtn_clicked()
{
    ui->tabWidget->setCurrentIndex(1);
}

void MA5600PlanDialog::on_desc8BackBtn_clicked()
{
    ui->tabWidget->setCurrentIndex(2);
}

void MA5600PlanDialog::on_desc7NextBtn_clicked()
{
    ui->tabWidget->setCurrentIndex(3);
}

void MA5600PlanDialog::on_desc080LE_textChanged(const QString &arg1)
{
    descChanged = true;
    if(arg1.isEmpty())
        entryCheck();
...
void MA5600PlanDialog::on_desc081LE_textChanged(const QString &arg1)
{
    descChanged = true;
    if(arg1.isEmpty())
        entryCheck();
...
void MA5600PlanDialog::on_desc082LE_textChanged(const QString &arg1)
{
    descChanged = true;
    if(arg1.isEmpty())
        entryCheck();
...
void MA5600PlanDialog::on_desc083LE_textChanged(const QString &arg1)
{
    descChanged = true;
    if(arg1.isEmpty())
        entryCheck();
...
void MA5600PlanDialog::on_desc084LE_textChanged(const QString &arg1)
{
    descChanged = true;
    if(arg1.isEmpty())
        entryCheck();
...
void MA5600PlanDialog::on_desc085LE_textChanged(const QString &arg1)
{
    descChanged = true;
    if(arg1.isEmpty())
        entryCheck();
