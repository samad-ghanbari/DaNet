#include "ma5600singleaggbrasplandialog.h"
#include "ui_ma5600singleaggbrasplandialog.h"
#include <QSqlQuery>
#include "lib/database/danetdbman.h"
#include <QMessageBox>

MA5600SingleAggBrasPlanDialog::MA5600SingleAggBrasPlanDialog(QWidget *parent, DanetDbMan *Db, const int Area, const int ExchId, const int DslamId, const QString dslamName) :
    QDialog(parent),
    ui(new Ui::MA5600SingleAggBrasPlanDialog),
    dbMan(Db),
    area(Area),
    dslamId(DslamId)
{
...
MA5600SingleAggBrasPlanDialog::~MA5600SingleAggBrasPlanDialog()
{
    delete ui;
}

void MA5600SingleAggBrasPlanDialog::checkEntry()
{
...
void MA5600SingleAggBrasPlanDialog::fillDesc()
{
    if(agg.isEmpty())
    {
        ui->v500DescLE->clear();
...
void MA5600SingleAggBrasPlanDialog::on_bras1CB_currentIndexChanged(int index)
{
    index++;
...
void MA5600SingleAggBrasPlanDialog::on_bras2CB_currentIndexChanged(int index)
{
    index++;
...
void MA5600SingleAggBrasPlanDialog::on_bras2EnCB_toggled(bool checked)
{
    if(checked)
    {
...
void MA5600SingleAggBrasPlanDialog::on_okBtn_clicked()
{
    bool ok = true;
...
void MA5600SingleAggBrasPlanDialog::on_vlan500CB_currentIndexChanged(int index)
{
...
void MA5600SingleAggBrasPlanDialog::on_vlan600CB_currentIndexChanged(int index)
{
    index++;
    fillDesc();
}

void MA5600SingleAggBrasPlanDialog::on_vlan700CB_currentIndexChanged(int index)
{
    index++;
    fillDesc();
}

void MA5600SingleAggBrasPlanDialog::on_vlan800CB_currentIndexChanged(int index)
{
    index++;
    fillDesc();
}

void MA5600SingleAggBrasPlanDialog::on_back3Btn_clicked()
{
    ui->tabWidget->setCurrentIndex(1);
}

void MA5600SingleAggBrasPlanDialog::on_next2Btn_clicked()
{
    ui->tabWidget->setCurrentIndex(2);
}

void MA5600SingleAggBrasPlanDialog::on_back2Btn_clicked()
{
    ui->tabWidget->setCurrentIndex(0);
}

void MA5600SingleAggBrasPlanDialog::on_next1Btn_clicked()
{
    ui->tabWidget->setCurrentIndex(1);
}
