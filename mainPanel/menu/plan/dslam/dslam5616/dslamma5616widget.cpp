...
#include "mainPanel/menu/plan/dslam/dslam5616/ma5616singleaggbrasplandialog.h"
...
void DslamMa5616Widget::on_brasPlanBtn_clicked()
{
    if(singleAgg)
    {
        MA5616SingleAggBrasPlanDialog *ma5616BrasPlanDialog = new MA5616SingleAggBrasPlanDialog(this, dbMan, area, exchId, dslamId, dslamName);
