#include "ma5616brasplandialog.h"
#include "ui_ma5616brasplandialog.h"
#include "lib/database/danetdbman.h"
#include <QSqlQuery>
#include <QMessageBox>

MA5616BrasPlanDialog::MA5616BrasPlanDialog(QWidget *parent, DanetDbMan *Db, const int Area, const int ExchId, const int DslamId, const QString dslamName) :
    QDialog(parent),
    ui(new Ui::MA5616BrasPlanDialog),
    dbMan(Db),
    area(Area),
    dslamId(DslamId)
{
...
MA5616BrasPlanDialog::~MA5616BrasPlanDialog()
{
    delete ui;
}

void MA5616BrasPlanDialog::checkEntry()
{
...
void MA5616BrasPlanDialog::fillDesc()
{
    if(agg.isEmpty())
    {
        ui->v500DescLE->clear();
...
void MA5616BrasPlanDialog::on_bras1CB_currentIndexChanged(int index)
{
    index++;
...
void MA5616BrasPlanDialog::on_bras2EnCB_toggled(bool checked)
{
    if(checked)
    {
...
void MA5616BrasPlanDialog::on_bras2CB_currentIndexChanged(int index)
{
    index++;
...
void MA5616BrasPlanDialog::on_okBtn_clicked()
{
    bool ok = true;
...
void MA5616BrasPlanDialog::on_vlan500CB_currentIndexChanged(int index)
{
...
void MA5616BrasPlanDialog::on_vlan600CB_currentIndexChanged(int index)
{
    index++;
    fillDesc();
}

void MA5616BrasPlanDialog::on_vlan700CB_currentIndexChanged(int index)
{
    index++;
    fillDesc();
}

void MA5616BrasPlanDialog::on_vlan800CB_currentIndexChanged(int index)
{
    index++;
    fillDesc();
}

void MA5616BrasPlanDialog::on_vlanBackBtn_clicked()
{
    ui->tabWidget->setCurrentIndex(1);
}

void MA5616BrasPlanDialog::on_next1Btn_clicked()
{
    ui->tabWidget->setCurrentIndex(1);
}

void MA5616BrasPlanDialog::on_back2Btn_clicked()
{
    ui->tabWidget->setCurrentIndex(0);
}

void MA5616BrasPlanDialog::on_next2Btn_clicked()
{
