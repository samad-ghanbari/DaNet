...
Mxk819SingleAggBrasPlanDialog::Mxk819SingleAggBrasPlanDialog(QWidget *parent, DanetDbMan *Db, const int Area, const int ExchId, const int DslamId, const QString dslamName) :
    QDialog(parent),
    ui(new Ui::Mxk819SingleAggBrasPlanDialog),
    dbMan(Db),
    area(Area),
    dslamId(DslamId)
{
...
Mxk819SingleAggBrasPlanDialog::~Mxk819SingleAggBrasPlanDialog()
{
    delete ui;
}

void Mxk819SingleAggBrasPlanDialog::checkEntry()
{
...
void Mxk819SingleAggBrasPlanDialog::fillDesc()
{
    if(agg.isEmpty())
    {
        ui->v500DescLE->clear();
...
void Mxk819SingleAggBrasPlanDialog::on_bras1CB_currentIndexChanged(int index)
{
    index++;
...
void Mxk819SingleAggBrasPlanDialog::on_bras2CB_currentIndexChanged(int index)
{
    index++;
...
void Mxk819SingleAggBrasPlanDialog::on_bras2EnCB_toggled(bool checked)
{
    if(checked)
    {
...
void Mxk819SingleAggBrasPlanDialog::on_okBtn_clicked()
{
    bool ok = true;
...
void Mxk819SingleAggBrasPlanDialog::on_vlan500CB_currentIndexChanged(int index)
{
...
void Mxk819SingleAggBrasPlanDialog::on_vlan600CB_currentIndexChanged(int index)
{
    index++;
    fillDesc();
}

void Mxk819SingleAggBrasPlanDialog::on_vlan700CB_currentIndexChanged(int index)
{
    index++;
    fillDesc();
}

void Mxk819SingleAggBrasPlanDialog::on_vlan800CB_currentIndexChanged(int index)
{
    index++;
    fillDesc();
}

void Mxk819SingleAggBrasPlanDialog::on_vlanBackBtn_clicked()
{
    ui->tabWidget->setCurrentIndex(1);
}

void Mxk819SingleAggBrasPlanDialog::on_next1Btn_clicked()
{
    ui->tabWidget->setCurrentIndex(1);
}

void Mxk819SingleAggBrasPlanDialog::on_Back2Btn_clicked()
{
    ui->tabWidget->setCurrentIndex(0);
}

void Mxk819SingleAggBrasPlanDialog::on_next2Btn_clicked()
{
