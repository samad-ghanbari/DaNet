...
void Mxk819SingleAggMetroPlanDialog::on_agg2CB_currentIndexChanged(int index)
{
    index++;
    AggChanged = true;
...
void Mxk819SingleAggMetroPlanDialog::on_agg2EthSB_valueChanged(int arg1)
{
    arg1++;
    AggChanged = true;
    checkEntry();
...
void Mxk819SingleAggMetroPlanDialog::on_agg2Int1CB_currentIndexChanged(int index)
{
    index++;
    AggChanged = true;
    checkEntry();
...
void Mxk819SingleAggMetroPlanDialog::on_agg2Int2CB_currentIndexChanged(int index)
{
    index++;
    AggChanged = true;
    checkEntry();
...
void Mxk819SingleAggMetroPlanDialog::on_agg1dIntCB_toggled(bool checked)
{
    AggChanged = true;
...
void Mxk819SingleAggMetroPlanDialog::on_agg2ConnCB_toggled(bool checked)
{
    AggChanged = true;
...
void Mxk819SingleAggMetroPlanDialog::on_agg2dIntCB_toggled(bool checked)
{
    AggChanged = true;
...
void Mxk819SingleAggMetroPlanDialog::on_a2i1diCB_currentIndexChanged(int index)
{
    index++;
    AggChanged = true;
    checkEntry();
...
void Mxk819SingleAggMetroPlanDialog::on_a2i2diCB_currentIndexChanged(int index)
{
    index++;
    AggChanged = true;
    checkEntry();
...
void Mxk819SingleAggMetroPlanDialog::on_a2mCB_currentIndexChanged(int index)
{
    AggChanged = true;
    index++;
    checkEntry();
...
void Mxk819SingleAggMetroPlanDialog::on_next1Btn_clicked()
{
    ui->tabWidget->setCurrentIndex(1);
}

void Mxk819SingleAggMetroPlanDialog::on_back2Btn_clicked()
{
    ui->tabWidget->setCurrentIndex(0);
}

void Mxk819SingleAggMetroPlanDialog::on_Next2Btn_clicked()
{
