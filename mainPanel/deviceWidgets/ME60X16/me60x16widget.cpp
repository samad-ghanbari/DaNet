#include "me60x16widget.h"
#include "ui_me60x16widget.h"
#include <QSqlQueryModel>

#define UnusedSlotColor "#c9bd43"

ME60X16Widget::ME60X16Widget(QWidget *parent, QSqlQueryModel *model) :
    QWidget(parent),
    ui(new Ui::ME60X16Widget)
{
    ui->setupUi(this);
...
ME60X16Widget::~ME60X16Widget()
{
    delete ui;
}

void ME60X16Widget::hideSlots()
{
...
QString ME60X16Widget::stringToVerticalString(QString string)
{
    if(string.isEmpty())
        return "";
...
void ME60X16Widget::setText(const int slot, int subSlot, QString card)
{
    if(slot == 1)
    {
        if(subSlot == 0)
