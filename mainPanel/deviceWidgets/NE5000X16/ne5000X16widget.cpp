#include "ne5000X16widget.h"
#include "ui_ne5000X16widget.h"
#include <QSqlQueryModel>

#define UnusedSlotColor "#c9bd43"

NE5000X16Widget::NE5000X16Widget(QWidget *parent, QSqlQueryModel *model) :
    QWidget(parent),
    ui(new Ui::NE5000X16Widget)
{
    ui->setupUi(this);
...
NE5000X16Widget::~NE5000X16Widget()
{
    delete ui;
}

void NE5000X16Widget::hideSlots()
{
...
QString NE5000X16Widget::stringToVerticalString(QString string)
{
...
void NE5000X16Widget::setText(const int slot, int subSlot, QString card)
{
    if(slot == 1)
    {
        if(subSlot == 0)
