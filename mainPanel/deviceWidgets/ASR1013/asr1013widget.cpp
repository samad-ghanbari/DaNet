#include "asr1013widget.h"
#include "ui_asr1013widget.h"
#include <QSqlQueryModel>

#define UnusedSlotColor "#c9bd43"

ASR1013Widget::ASR1013Widget(QWidget *parent, QSqlQueryModel *model) :
    QWidget(parent),
    ui(new Ui::ASR1013Widget)
{
    ui->setupUi(this);
...
ASR1013Widget::~ASR1013Widget()
{
    delete ui;
}

void ASR1013Widget::hideSlots()
{

    //    ui->s1s0->setVisible(false);
