#include "s9303widget.h"
#include "ui_s9303widget.h"
#include <QSqlQueryModel>

#define UnusedSlotColor "#c9bd43"

S9303Widget::S9303Widget(QWidget *parent, QSqlQueryModel *model) :
    QWidget(parent),
    ui(new Ui::S9303Widget)
{
    ui->setupUi(this);
...
S9303Widget::~S9303Widget()
{
    delete ui;
}

void S9303Widget::hideSlots()
{
...
void S9303Widget::setText(const int slot, int subSlot, QString card)
{
    if(slot == 1)
    {
        if(subSlot == 0)
