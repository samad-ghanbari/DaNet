#include "ne40x16widget.h"
#include "ui_ne40x16widget.h"
#include <QSqlQueryModel>

#define UnusedSlotColor "#c9bd43"

NE40X16Widget::NE40X16Widget(QWidget *parent,const bool NE40FLAG, QSqlQueryModel *model) :
    QWidget(parent),
    ui(new Ui::NE40X16Widget)
{
    ui->setupUi(this);
...
NE40X16Widget::~NE40X16Widget()
{
    delete ui;
}

void NE40X16Widget::hideSlots()
{
...
QString NE40X16Widget::stringToVerticalString(QString string)
{
...
void NE40X16Widget::setText(const int slot, int subSlot, QString card)
{
    if(slot == 1)
    {
        if(subSlot == 0)
