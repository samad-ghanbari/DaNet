...
Report::Report(QObject *Parent, const QAbstractItemModel* tableModel, const QVector<QString> Headers, const QVector<int> ColumnStretch, const QString OutputPath, const QString ReportTopic, const QString CustomInfo) :
    QObject(Parent),
...
void Report::preparePage(QPainter *painter)
{ // print a border on each page
    ...
    painter->drawText(rec,Qt::AlignCenter,"DaNet "+reportTopic+" Report");
...
bool Report::print()
{
    ...
    pr->setDocName(reportTopic +" Report");
...
bool Report::printTable(QPrinter *p)
{
    QPrinter *printer = p;
