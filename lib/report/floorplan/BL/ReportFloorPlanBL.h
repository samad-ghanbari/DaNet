#ifndef REPORTFLOORPLANBL_H
#define REPORTFLOORPLANBL_H
...
class ReportFloorPlanBL : public QObject
{
    Q_OBJECT
public:
  ReportFloorPlanBL(QObject *parent, QAbstractItemModel *Model, const QString Abbr, const QString Exchange, const QString Saloon, const QString OutputPath, const int PaperSize, const int Orient, const QFont Font, const QString CustomInfo);
  ~ReportFloorPlanBL();
  QString lastError();
  void preparePage();
  bool print();
