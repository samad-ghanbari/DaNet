#include "ReportFloorPlanBL.h"
#include <QAbstractItemModel>
#include <QDate>
#include <QPainter>

ReportFloorPlanBL::ReportFloorPlanBL(QObject *parent, QAbstractItemModel *Model, const QString Abbr, const QString Exchange, const QString Saloon, const QString OutputPath, const int PaperSize, const int Orient, const QFont Font, const QString CustomInfo="") :
    QObject(parent),
...
ReportFloorPlanBL::~ReportFloorPlanBL()
{
    delete painter;
    painter = NULL;
}

void ReportFloorPlanBL::preparePage()
{
    ...
    painter->translate(0, painter->viewport().height()-bottomHeight-rackHeight-50); // start print point
}

bool ReportFloorPlanBL::print()
{
    if( model->rowCount() == 0 )
    {
...
int ReportFloorPlanBL::getStartRackNo()
{
    int srn = 1;
    int rn;
...
QMap<int, QList<QString> > ReportFloorPlanBL::getrackInfo()
{
...
int ReportFloorPlanBL::odfCount(const int rackRow, const int rackNo)
{
...
void ReportFloorPlanBL::drawOdf(const int rackRow, const int rackNo,const QString device, const int odfNo, const int ppp)
{
...
void ReportFloorPlanBL::drawRack(const int rackRow, const int rackNo, const int shelfCount, const QList<QString> devices)
{
...
void ReportFloorPlanBL::drawRackRow(const int rackRow)
{
...
QString ReportFloorPlanBL::lastError()
{
    return error;
}
