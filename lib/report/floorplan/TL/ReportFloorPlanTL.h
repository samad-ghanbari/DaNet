#ifndef REPORTFLOORPLANTL_H
#define REPORTFLOORPLANTL_H
...
class ReportFloorPlanTL : public QObject
{
    Q_OBJECT
public:
  ReportFloorPlanTL(QObject *parent, QAbstractItemModel *Model, const QString Abbr, const QString Exchange, const QString Saloon, const QString OutputPath, const int PaperSize, const int Orient, const QFont Font, const QString CustomInfo="");
  ~ReportFloorPlanTL();
  QString lastError();
  void preparePage();
  bool print();
